...
# To test the effect of a parameter, comment it and modify the parameter in the loop of the model (line 367)
...
# Modify the parameter you want to test in the if (line 371) and else (line 378)
...
param = 2                   # Number of steps per replication
